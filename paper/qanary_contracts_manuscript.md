...
- *Tridirectional* = (a) negative-instance attack reproduction on the DAO 2016 vulnerable pattern (Layer 6-A), (b) positive-instance correctness proof against the Compound v2 cToken family (Layer 6-B), (c) boundary-case proof against the Aave V3 supply/borrow flow (Layer 6-C).
...
- **Four protocol instantiations** exercised: DAO 2016 (negative); Compound v2 cToken (positive); Aave V3 supply/borrow (boundary); composition across the three (meta).
