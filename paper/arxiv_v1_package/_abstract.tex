...
reproducibility verified at tagged commit \texttt{v1.5-phase6-closure}
(the Phase 6 closure seal; the substantive proof substrate is
independently reproducible at \texttt{v1.3-layer6-closure} per §10.3.3).
