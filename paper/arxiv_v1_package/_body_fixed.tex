...
\section{Appendix A: Theorem Statements, Axiom Records, and
Reproduction}\label{appendix-a-theorem-statements-axiom-records-and-reproduction}
...
\subsection{Appendix A.1 Theorem
statements}\label{appendix-a.1-theorem-statements}
...
\subsection{Appendix A.2 Per-theorem axiom
records}\label{appendix-a.2-per-theorem-axiom-records}
...
\subsection{Appendix A.3 Reproduction
commands}\label{appendix-a.3-reproduction-commands}
...
\section{Appendix B: Methodology Framework
Pointer}\label{appendix-b-methodology-framework-pointer}

\subsection{Appendix B.1 Scope of this
pointer}\label{appendix-b.1-scope-of-this-pointer}
...
\subsection{Appendix B.2 Canonical
artifacts}\label{appendix-b.2-canonical-artifacts}
...
\section{Appendix C: Comparison against industrial FV
frameworks}\label{appendix-c-comparison-against-industrial-fv-frameworks}
